...
// Function to populate the table with players data
        function populateTable(players) {
            ...
            players.forEach(player => {
                ...
                if (player.market_value_in_eur === null){
                    marketValueCell.textContent = 'UNKNOWN';
                }
                else{
...
function convertDateFormat(dateStr) {
    // Check if the input date string is in the expected format
